...
static u32 tegra_pmc_r2p_set_cfg(struct hekate_boot_cfg *hekate_bcfg)
{
    ...
    arm_smccc_smc(TEGRA_SIP_R2P_SET_BIN_CFG, hekate_boot_smc_cfg[0],
            hekate_boot_smc_cfg[1], hekate_boot_smc_cfg[2],
            hekate_boot_smc_cfg[3], 0, 0, 0, &res);
